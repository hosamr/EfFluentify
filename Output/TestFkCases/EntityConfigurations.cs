...
internal sealed class ChildConfiguration : IEntityTypeConfiguration<Child>
{
    ...
    {
        builder.HasOne(x => x.Mother).WithMany(x => x.ChildrenByMother).HasForeignKey(x => x.MotherId).IsRequired();
        builder.HasOne(x => x.Father).WithMany(x => x.ChildrenByFather).HasForeignKey(x => x.FatherId).IsRequired();
...
internal sealed class FlightConfiguration : IEntityTypeConfiguration<Flight>
{
    ...
    {
        builder.HasOne(x => x.DepartureAirport).WithMany(x => x.DepartingFlights).HasForeignKey(x => x.DepartureAirportId).IsRequired();
